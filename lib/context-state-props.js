...
function contextStateProps(state,mutations,mergeProps,opt) {
  return function(Component) {
    var SP = function(props,context) {
      var modOpts = _assign({},opt,{mutagen:context.store.mutagen(context.store.dispatch)});
      var componentWithMutagen = stateProps(state,mutations,mergeProps,modOpts)(Component);
